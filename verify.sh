...
# Американська норма в транскрипціях (сесія 50): гра — UA→US і `u.lang="en-US"`,
# тож британські ɒ/əʊ/eə/ɐ і неротичність тут помилка. Аудит знайшов 555 таких
# записів, які приїхали з британських джерел, — вартовий не дає їм повернутись.
node check-ipa.js || exit 1
# Американська норма в НАПИСАННІ (сесія 51): картка мусить мати амер. форму основною,
# британська — в `enAlt`. Аудит знайшов 70 карток («favourite», «grey», «licence plate»)
# і 152 речення; без вартового кожна нова партія тягнула б британізми далі.
node check-brit.js || exit 1
